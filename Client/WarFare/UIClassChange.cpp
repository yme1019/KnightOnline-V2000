...
bool CUIClassChange::Load(HANDLE hFile)
{
	...
	m_pBtn_Class0		= (CN3UIButton*)GetChildByID("Btn_Class0");		
	__ASSERT(m_pBtn_Class0,	" m_pBtn_Class0NULL UI Component!");

	m_pBtn_Class1		= (CN3UIButton*)GetChildByID("Btn_Class1");		
	__ASSERT(m_pBtn_Class1,	"m_pBtn_Class1 NULL UI Component!");

	m_pText_Warning		= (CN3UIString*)GetChildByID("Text_Waring");	
	__ASSERT(m_pText_Warning, "m_pText_Warning NULL UI Component!");

	m_pText_Info0		= (CN3UIString*)GetChildByID("Text_info0");		
	__ASSERT(m_pText_Info0, "m_pText_Info0 NULL UI Component!");

	m_pText_Info1		= (CN3UIString*)GetChildByID("Text_info1");		
	__ASSERT(m_pText_Info1, "m_pText_Info1 NULL UI Component!");
		...
		case N3_SP_CLASS_CHANGE_SUCCESS:
			...
			switch ( pInfoBase->eClass )
			{
				case CLASS_KARUS_WARRIOR:
					CGameProcedure::GetTextByClass(CLASS_KARUS_BERSERKER, szClassTmp); m_pText_Info0->SetString(szClassTmp);
					CGameProcedure::GetTextByClass(CLASS_KARUS_GUARDIAN, szClassTmp); m_pText_Info1->SetString(szClassTmp);
					break;
				case CLASS_KARUS_ROGUE:
					CGameProcedure::GetTextByClass(CLASS_KARUS_HUNTER, szClassTmp); m_pText_Info0->SetString(szClassTmp);
					CGameProcedure::GetTextByClass(CLASS_KARUS_PENETRATOR, szClassTmp); m_pText_Info1->SetString(szClassTmp);
					break;
				case CLASS_KARUS_WIZARD:
					CGameProcedure::GetTextByClass(CLASS_KARUS_SORCERER, szClassTmp); m_pText_Info0->SetString(szClassTmp);
					CGameProcedure::GetTextByClass(CLASS_KARUS_NECROMANCER, szClassTmp); m_pText_Info1->SetString(szClassTmp);
					break;
				case CLASS_KARUS_PRIEST:
					CGameProcedure::GetTextByClass(CLASS_KARUS_SHAMAN, szClassTmp); m_pText_Info0->SetString(szClassTmp);
					CGameProcedure::GetTextByClass(CLASS_KARUS_DARKPRIEST, szClassTmp); m_pText_Info1->SetString(szClassTmp);
					break;
				case CLASS_ELMORAD_WARRIOR:
					CGameProcedure::GetTextByClass(CLASS_ELMORAD_BLADE, szClassTmp); m_pText_Info0->SetString(szClassTmp);
					CGameProcedure::GetTextByClass(CLASS_ELMORAD_PROTECTOR, szClassTmp); m_pText_Info1->SetString(szClassTmp);
					break;
				case CLASS_ELMORAD_ROGUE:
					CGameProcedure::GetTextByClass(CLASS_ELMORAD_RANGER, szClassTmp); m_pText_Info0->SetString(szClassTmp);
					CGameProcedure::GetTextByClass(CLASS_ELMORAD_ASSASIN, szClassTmp); m_pText_Info1->SetString(szClassTmp);
					break;
				case CLASS_ELMORAD_WIZARD:
					CGameProcedure::GetTextByClass(CLASS_ELMORAD_MAGE, szClassTmp); m_pText_Info0->SetString(szClassTmp);
					CGameProcedure::GetTextByClass(CLASS_ELMORAD_ENCHANTER, szClassTmp); m_pText_Info1->SetString(szClassTmp);
					break;
				case CLASS_ELMORAD_PRIEST:
					CGameProcedure::GetTextByClass(CLASS_ELMORAD_CLERIC, szClassTmp); m_pText_Info0->SetString(szClassTmp);
					CGameProcedure::GetTextByClass(CLASS_ELMORAD_DRUID, szClassTmp); m_pText_Info1->SetString(szClassTmp);
					break;
			}
			break;
...
bool CUIClassChange::ReceiveMessage(CN3UIBase* pSender, uint32_t dwMsg)
{
	...
	if (dwMsg == UIMSG_BUTTON_CLICK)					
	{
		...
		else if(pSender == m_pBtn_Class0)
		{
			...
			{
				case CLASS_KARUS_WARRIOR:
					pInfoBase->eClass = CLASS_KARUS_BERSERKER;
					break;
				case CLASS_KARUS_ROGUE:
					pInfoBase->eClass = CLASS_KARUS_HUNTER;
					break;
				case CLASS_KARUS_WIZARD:
					pInfoBase->eClass = CLASS_KARUS_SORCERER;
					break;
				case CLASS_KARUS_PRIEST:
					pInfoBase->eClass = CLASS_KARUS_SHAMAN;
					break;
				case CLASS_ELMORAD_WARRIOR:
					pInfoBase->eClass = CLASS_ELMORAD_BLADE;
					break;
				case CLASS_ELMORAD_ROGUE:
					pInfoBase->eClass = CLASS_ELMORAD_RANGER;
					break;
				case CLASS_ELMORAD_WIZARD:
					pInfoBase->eClass = CLASS_ELMORAD_MAGE;
					break;
				case CLASS_ELMORAD_PRIEST:
					pInfoBase->eClass = CLASS_ELMORAD_CLERIC;
					break;
			}

			CGameProcedure::s_pProcMain->m_pUIVar->UpdateAllStates(pInfoBase, pInfoExt); 

...
bool CUIKnightsOperation::Load(HANDLE hFile)
{
	...
	__ASSERT(m_pBtn_Up, "m_pBtn_Up NULL UI Component!!");

	m_pBtn_Down = (CN3UIButton*)(this->GetChildByID("btn_down"));	
	__ASSERT(m_pBtn_Down, "m_pBtn_Down NULL UI Component!!");
	...
	__ASSERT(m_pList_Knights, "m_pList_Knights NULL UI Component!!");
	...
	__ASSERT(m_pBtn_Create, "m_pBtn_Create NULL UI Component!!");

	m_pBtn_Destroy =		(CN3UIButton*)(this->GetChildByID("Btn_Destroy"));		
	__ASSERT(m_pBtn_Destroy, "m_pBtn_Destroy NULL UI Component!!");

	m_pBtn_Withdraw =		(CN3UIButton*)(this->GetChildByID("Btn_Withdraw"));		
	__ASSERT(m_pBtn_Withdraw, "m_pBtn_Withdraw NULL UI Component!!");

	m_pEdit_KnightsName =	(CN3UIEdit*)(this->GetChildByID("Edit_KnightsName"));	
	__ASSERT(m_pEdit_KnightsName, "m_pEdit_KnightsName NULL UI Component!!");

...
{	
	...
	SDL_Window* pWindow = SDL_CreateWindow("KnightOnline", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, CN3Base::s_Options.iViewWidth, CN3Base::s_Options.iViewHeight, windowFlags);
	...
	{ 
		CGameProcedure::TickActive(); CGameProcedure::RenderActive();
	}

...
const uint32_t RF_ALPHABLENDING		= 0x1;
const uint32_t RF_NOTUSEFOG			= 0x2;
const uint32_t RF_DOUBLESIDED		= 0x4;
const uint32_t RF_BOARD_Y			= 0x8;
const uint32_t RF_POINTSAMPLING		= 0x10;
const uint32_t RF_WINDY				= 0x20;		
const uint32_t RF_NOTUSELIGHT		= 0x40;
const uint32_t RF_DIFFUSEALPHA		= 0x80;
const uint32_t RF_NOTZWRITE			= 0x100;
const uint32_t RF_UV_CLAMP			= 0x200;
const uint32_t RF_NOTZBUFFER		= 0x400;
...
const int MAX_MIPMAP_COUNT = 10; // 1024 * 1024
...
inline bool _IntersectTriangle(const __Vector3& vOrig, const __Vector3& vDir, const __Vector3& v0, const __Vector3& v1, const __Vector3& v2, float& fT, float& fU, float& fV, __Vector3* pVCol)
{
...
inline void _Convert2D_To_3DCoordinate(	int ixScreen, int iyScreen, const __Matrix44& mtxView, const __Matrix44& mtxPrj, const D3DVIEWPORT9& vp, __Vector3& vPosResult, __Vector3& vDirResult)
{
